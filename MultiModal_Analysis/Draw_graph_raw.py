...
# 그래프 하나 그려보기 C:\\Users\\user\\Downloads\\Face Video\\ 
...
# 1초 단위가 아닌 프레임 단위
data_xlse = pd.read_excel('C:/Users/user/Downloads/Face Video/Face_1W_A1_S2_central.xlsx') # head_pose_coordinates_A1.csv
# C:/Users/HarryAnnie/Downloads/A1_result/delta_ratio_A1.xlsx'2.
# C:\Users\user\Downloads\Face Video
data = data_xlse['box.center_y'] # box 중점의 y좌표 값을 기준. # Lip Distance Difference
...
# 그래프 제목 및 라벨 설정
ax.set_title('20 min Y axis graph')
ax.set_xlabel('Time (seconds)')
ax.set_ylabel('box.center_y') # lip distance
